    ...
    >
      <g id="Logo">
        <g id="Group 3">
          ...
          >
            <path
              ...
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M0 0.849854H37.541V38.3915H0V0.849854Z"
              fill="white"
            />
          </mask>
        ...
        <path
          ...
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M28.025 13.707C27.5873 13.707 27.2269 13.9901 27.2269 14.4542V24.7613C27.2269 25.2254 27.5873 25.5084 28.025 25.5084C28.4636 25.5084 28.7985 25.2254 28.7985 24.7613V14.4542C28.7985 13.9901 28.4636 13.707 28.025 13.707Z"
          fill="#12110F"
        />
      </g>
    </svg>
